...
//---------------------------------------------------------------------------------------------------------//
// create a serializable CreditMLModel class
@SerialVersionUID(123L)	
object CreditMLModel extends Serializable  {
			...
			case class Credit(
			    ...
			    val realTimeCreditData: String =("file:///home/cloudera/Real-Time-Credit-Risk-Analysis/credit/realtimedata.csv")
...
//-------------------------------------------------------------------------------------------------------------//
				...
				//	realTimeMessage = args(0)
				//	println("agrs(0) : " + args(0))
				...
				val creditRealTimeRDD = (spark.sparkContext).textFile(realTimeCreditData)
				println("2")
				creditRealTimeRDD.count
